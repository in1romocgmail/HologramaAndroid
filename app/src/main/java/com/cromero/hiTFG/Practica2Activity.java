...
public class Practica2Activity extends CustomActivity implements OnCompletionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num = ProcesarNumero(nivel);

        numero = ProcesaContador(num, 1);
        numeroimagen = ProcesaContador(num, 2);
        cadenaAnalizar = ProcesaCadena(num);
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        Intent i = new Intent(this, Reconocimiento2.class);
    ...
    public int ProcesaContador(int contador, int var) {
        ...
        switch (contador) {
            ...
            default:
                ...
                Intent i = new Intent();
                i.setClass(Practica2Activity.this, ReproducirFinal.class);
                finish();
                startActivity(i);
    ...
    private int ProcesarNumero(int nivel) {
        int aleatorio;
        int max;
        int min;
