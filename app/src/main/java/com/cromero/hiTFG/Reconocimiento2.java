...
public class Reconocimiento2 extends CustomActivity implements
        RecognitionListener {
    ...
    public void onResults(Bundle results) {
        ...
        i.setClass(Reconocimiento2.this, Respuesta2.class);

        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); // <- Aquí :)
        startActivity(i);
        finish();
